...
class RewardSystemActivity:BaseActivity(R.layout.activity_reward_system),ToolbarHelper{
    ...
    companion object {
        fun newIntent(mActivity: AppCompatActivity): Intent {
            val intent = Intent(mActivity,RewardSystemActivity::class.java)
            return intent
        }
    }
    ...
    override fun onActivityCreated() {
        ...
        add_coin.setOnClickListener {
            startActivity(PaymentActivity.newIntent(mActivity))
        }
    }
