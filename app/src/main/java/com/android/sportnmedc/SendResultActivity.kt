...
class SendResultActivity:BaseActivity(R.layout.activity_send_result),ToolbarHelper{
    ...
    companion object {
        fun newIntent(mActivity: AppCompatActivity, address:String, amount:String): Intent {
            val intent = Intent(mActivity,SendResultActivity::class.java)
    ...
    override fun onActivityCreated() {
        ...
        transaction_detail_btn.setOnClickListener {
           startActivity(TransactionDetailActivity.newIntent(mActivity,amount))
        }
