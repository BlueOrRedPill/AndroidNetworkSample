...
class TradeConfirmActivity:BaseActivity(R.layout.activity_trade_confirm),ToolbarHelper{
    ...
    companion object {
        fun newIntent(mActivity: AppCompatActivity,mTradeModel: TradeModel): Intent {
            val intent = Intent(mActivity,TradeConfirmActivity::class.java)
    ...
    override fun onActivityCreated() {
        ...
        confirm_btn.setOnClickListener {
            DialogHelper.createConfirmDialog(mActivity,getString(R.string.app_name),"Do you want trade this card with other user?",
