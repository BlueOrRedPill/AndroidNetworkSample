...
class SelectCardActivity: BaseActivity(R.layout.activity_select_card), ToolbarHelper {
    ...
    companion object {
        fun newIntent(mActivity: AppCompatActivity, tradeModel: TradeModel,index:Int,isCardOut:Boolean): Intent {
            val intent = Intent(mActivity, SelectCardActivity::class.java)
            ...
            override fun onItemClicked(v: View, position: Int) {
                when(v.id){
                    R.id.card_add ->{
                        ...
                        Utils.hideKeyboard(this@SelectCardActivity)
