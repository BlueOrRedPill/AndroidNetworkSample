...
import com.android.sportnmedc.TradeNewActivity
...
class TradeFragment: BaseFragment(R.layout.fragment_trade){
...
//        })
        ...
        new_btn.setOnClickListener {
            startActivityForResult(TradeNewActivity.newIntent(mActivity),Utils.REQUEST_CODE_TRADE)
        }
