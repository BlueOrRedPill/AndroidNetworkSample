...
class TradeDetailActivity:BaseActivity(R.layout.activity_trade_detail),ToolbarHelper{
    ...
    companion object {
        fun newIntent(mActivity: AppCompatActivity,tradeModel:TradeModel): Intent {
            val intent = Intent(mActivity,TradeDetailActivity::class.java)
    ...
    fun updateContent(tradeModel:TradeModel){
        ...
        tradeModel.user.let {
            ...
            if ( UserSource().getCurrentProfile().name.equals(it.name)){
