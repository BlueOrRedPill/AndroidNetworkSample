...
class SendDetailActivity :BaseActivity(R.layout.activity_send_detail), ToolbarHelper {
...
//    val arrGroupView = arrayListOf<GroupView>()
    ...
    companion object {
        fun newIntent(mActivity: AppCompatActivity,address:String): Intent {
            val intent = Intent(mActivity,SendDetailActivity::class.java)
       ...
       val address = intent.getStringExtra("address")?:""
        ...
        confirm_btn.setOnClickListener {
           ...
           if (amount.isNullOrEmpty() || amount.equals("0")){
               ...
               startActivityForResult(SendConfirmActivity.newIntent(mActivity,address,amount),Utils.REQUEST_CODE_ADD_COIN)
           }
