...
class TradeActivity:BaseActivity(R.layout.activity_trade),ToolbarHelper{

    val mUserRepositories = UserSource()
    ...
    companion object {
        fun newIntent(mActivity: AppCompatActivity,card:CardModel): Intent {
            val intent = Intent(mActivity,TradeActivity::class.java)
