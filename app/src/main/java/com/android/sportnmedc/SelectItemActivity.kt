...
class SelectItemActivity:BaseActivity(R.layout.activity_select_item),ToolbarHelper{
...
//    private var selectItemIn = true
    ...
    companion object {
        fun newIntent(mActivity: AppCompatActivity,mTradeModel:TradeModel): Intent {
            val intent = Intent(mActivity,SelectItemActivity::class.java)
        ...
        add_item.setOnClickListener {
            if (itemSelectedIn.size > 0  && itemSelectedOut.size > 0) {
                ...
                startActivityForResult(
                    TradeConfirmActivity.newIntent(mActivity, mTradeModel),
